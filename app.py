...
temp = st.slider(label="Select temperature Level",min_value=5.0,max_value=60.0)
humidity = st.slider(label="Select Potassium Level",min_value=10.0,max_value=150.0)
ph = st.slider(label="Select ph Level",min_value=0.0,max_value=14.0)
rainfall = st.slider(label="Select Rainfall Level",min_value=10.0,max_value=300.0)
